...
import '../financePages/ActionPages/newEntryBills.dart';

class BillingPage extends StatefulWidget {
  const BillingPage({Key? key}) : super(key: key);

  @override
  BillingPage_ createState() => BillingPage_();
}

class BillingPage_ extends State<BillingPage> {
  @override
                ...
                builder: (BuildContext context,
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        String totalBillingVar = "uhh";

                        if (FirebaseAuth.instance.currentUser!.uid ==
                            numbers.id) {
                          totalBillingVar = numbers['totalBills'].toString();
                          ...
                          return Row(
                              ...
                              children: <Widget>[
                                Padding(
                                  ...
                                  child: Text(
                                    "Total Bills Paid: \$$totalBillingVar",
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const NewEntryBills()));
                  },
      ...
      ElevatedButton(
        ...
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => NotePopUp(id: id, category: "bills")));
        },
