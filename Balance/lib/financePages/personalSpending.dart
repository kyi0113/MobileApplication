...
import '../financePages/ActionPages/newEntryPersonalSpending.dart';

class PersonalSpendingPage extends StatefulWidget {
  const PersonalSpendingPage({Key? key}) : super(key: key);

  @override
  PersonalSpendingPage_ createState() => PersonalSpendingPage_();
}

class PersonalSpendingPage_ extends State<PersonalSpendingPage> {
  @override
                ...
                builder: (BuildContext context,
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        String totalPersonalSpendingVar = "uhh";

                        if (FirebaseAuth.instance.currentUser!.uid ==
                            numbers.id) {
                          totalPersonalSpendingVar =
                              numbers['totalPersonalSpending'].toString();
                          ...
                          return Row(
                              ...
                              children: <Widget>[
                                Padding(
                                  ...
                                  child: Text(
                                    "Total Personal Spending: \$$totalPersonalSpendingVar",
                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        padding:
                                            const EdgeInsets.only(right: 40),
                                        child: Text(
                                            "\$${numbers["personalSpendingNumber"]}",
                                            style:
                                                const TextStyle(fontSize: 15)),
                                      ),
                                    ]),
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                const NewEntryPersonalSpending()));
                  },
      ...
      ElevatedButton(
        ...
        onPressed: () {
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      NotePopUp(id: id, category: "personalSpending")));
        },
