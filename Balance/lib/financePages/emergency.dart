...
import '../financePages/ActionPages/newEntryEmergency.dart';

class EmergencyPage extends StatefulWidget {
  const EmergencyPage({Key? key}) : super(key: key);

  @override
  EmergencyPage_ createState() => EmergencyPage_();
}

class EmergencyPage_ extends State<EmergencyPage> {
  @override
                ...
                builder: (BuildContext context,
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        String totalEmergencyVar = "uhh";

                        if (FirebaseAuth.instance.currentUser!.uid ==
                            numbers.id) {
                          totalEmergencyVar =
                              numbers['totalEmergency'].toString();
                          ...
                          return Row(
                              ...
                              children: <Widget>[
                                Padding(
                                  ...
                                  child: Text(
                                    "Total Emergency Saved: \$$totalEmergencyVar",
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => NewEntryEmergency()));
                  },
      ...
      ElevatedButton(
        ...
        onPressed: () {
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      NotePopUp(id: id, category: "emergency")));
        },
